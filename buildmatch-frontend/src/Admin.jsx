...
export default function AdminDashboard({ user, onLogout, initialTab = "overview", hideHeader = false }) {
export default function AdminDashboard({ _user, onLogout, initialTab = "overview", hideHeader = false }) {
